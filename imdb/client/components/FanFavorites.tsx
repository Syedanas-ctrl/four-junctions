  ...
  return (
    <section className="max-w-7xl mx-auto px-4 mt-12">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold border-l-4 border-[#f5c518] pl-3">
          Fan favorites <ChevronRight className="inline-block w-5 h-5 ml-1" />
        </h2>
        <div className="flex space-x-3">
          <button className="bg-[#2c2c2c] px-4 py-1 rounded-full text-sm font-medium hover:bg-[#3d3d3d]">All</button>
          <button className="text-sm font-medium text-gray-400 hover:text-white">TV Shows</button>
          <button className="text-sm font-medium text-gray-400 hover:text-white">Movies</button>
        </div>
      </div>
        ...
        <div className="flex overflow-x-auto gap-4 pb-4 hide-scrollbar">
          ...
          <div className="flex-shrink-0 w-[180px] bg-[#1a1a1a] rounded overflow-hidden">
            <div className="relative">
              ...
              <div className="absolute bottom-0 right-0 bg-black/60 px-2 py-1 text-xs">IN THEATERS</div>
            </div>
            <div className="p-3">
              ...
              <h3 className="font-medium mb-2">Dune: Part Two</h3>
          ...
          <div className="flex-shrink-0 w-[180px] bg-[#1a1a1a] rounded overflow-hidden">
            <div className="relative">
              ...
              <div className="absolute bottom-0 right-0 bg-black/60 px-2 py-1 text-xs">APRIL 11</div>
            </div>
            <div className="p-3">
              <div className="flex items-center mb-2">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#f5c518" className="mr-1">
              ...
              <h3 className="font-medium mb-2">Fallout</h3>
              <button className="w-full bg-[#2c2c2c] text-[#5699ef] py-1 rounded text-sm mb-2">
                Watch options
              </button>
              <button className="w-full bg-[#2c2c2c] text-white py-1 rounded text-sm flex items-center justify-center">
